    ...
    format!(
        r#"(module
            ...
            (func (export "fp_init") (param i32 i32 f32 f32) (result i32)
                ...
                i32.const 0)
            (func (export "fp_event") (param i32 i32 f32 f32) (result i32)
                i32.const 0)
            ...
            (func (export "fp_state_len") (result i32) i32.const {state_length})
            (func (export "fp_state_schema") (result i32) i32.const {schema})
        )"#
    )
}
...
fn failed_candidate_never_mutates_or_replaces_the_working_plugin() {
    ...
    assert!(error.to_string().contains("fp_render"));
