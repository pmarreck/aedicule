...
export const english = Object.freeze({
	...
	aboutAbiLink: "Read the current + proposed ABI",
	aboutGuideLink: "Guide for humans and LLMs",
	abiReferenceTitle: "Aedicule ABI reference",
	abiReferenceLink: "Current + proposed ABI",
	abiReferenceBack: "Back to demos",
	abiReferenceEyebrow: "One generated capability boundary",
	abiReferenceHeadline: "CURRENT. PROPOSED. NEVER CONFUSED.",
	abiReferenceLead: "Every callable import below comes from Aedicule's checked runtime registry. Future directions are explicitly non-callable until their contracts and adapters ship.",
	abiCurrentTitle: "Callable now",
	abiCurrentDescription: "These imports link against ABI v0.9 today. Their signatures and descriptions share the same source as the checked Markdown reference and linker-conformance test.",
	abiProposedTitle: "Proposed",
	abiProposedDescription: "These cards preserve design direction without reserving import names or pretending unfinished platform adapters exist.",
	abiCallable: "Callable",
	abiNotCallable: "Not callable",
	abiEvidenceLink: "Evidence / specification",
	abiMarkdownLink: "Markdown ABI reference",
